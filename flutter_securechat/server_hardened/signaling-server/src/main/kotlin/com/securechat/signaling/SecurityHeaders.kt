...
internal val SECURITY_HEADERS: List<Pair<String, String>> = listOf(
    ...
    // Istemciler sunucuya yalniz TLS uzerinden baglanir. Baslik, araya giren
    // bir saldirganin ilk istegi duz HTTP'ye dusurmesini tarayici/HTTP
    // istemcisi tarafinda da kapatir; TLS'i sonlandiran proxy dususe gecerse
    // koruma uygulama katmaninda kalir.
