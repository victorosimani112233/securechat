...
class ChatActivityService {
  ...
  // Tus basina paket gonderilmez; hareket bittikten sonra tek bir durdu sinyali
  // gonderilir. Daha uzun pencere mobil trafikte churn'u azaltirken yeniden
  // yazmaya baslandiginda gostergenin hemen duyurulmasina engel olmaz.
  static const idleTimeout = Duration(seconds: 5);
