...
Son dogrulama: 2026-09-17. E2EE mesaj icerigini korur, fakat trafik iliskisini,
...
| Anonim teslim capability'si | Sealed Sender ciphertext'ini hedef cihaza yonlendirme | Kullanici bagi + monoton generation + ham mailbox/write key'i geri vermeyen amac-ayrimli HMAC indeksleri | Hesap/capability omru | Rotasyonda atomik replace veya hesap silmede cascade |
...
V20 official Rust libsignal icin yalniz public EC/Kyber PQXDH bundle'ini tutar;
tek kullanimlik EC/Kyber cifti atomik silinir ve tuketim zaman cizelgesi yoktur.
V21 Sealed Sender mailbox'inda ham capability yerine iki purpose-separated HMAC
indeksi ve generation tutar; hesap silme satiri cascade ile kaldirir.
...
- Flyway V1-V21 (V9 persistent grup grafigini, V10 behavioral audit tablosunu,
  ...
  siler; V20 modern public PQXDH bundle'ini, V21 anonim mailbox indeksini
  ekler), bot process'inden once signaling process'iyle tamamlanir. Backup
...
Son kanit: `flutter analyze`, 438/438 Flutter testi, statik privacy gate'leri,
uc ABI/21 stripped native library iceren server-secret audited AAB ve 1.179
signaling + 190 bot testi (sifir skip) basarilidir. Bu kod hedefinin
